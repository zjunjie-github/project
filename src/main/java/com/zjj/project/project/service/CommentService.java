...
public class CommentService {
    ...
    public void insert(Comment comment, User commentator) {
        ...
        if (comment.getType() == CommentTypeEnum.COMMENT.getType()){
            ...
            //创建通知
            createNoyify(comment,dbComment.getCommentator(),commentator.getName(), question.getTitle(), NoyificationTypeEnum.REPLY_COMMENT,question.getId());
        }else{
            //回复问题
            ...
            //创建通知
            createNoyify(comment,question.getCreator(), commentator.getName(),question.getTitle(), NoyificationTypeEnum.REPLY_QUESTION,question.getId());
        }
    }

    private void createNoyify(Comment comment, Long receiver, String notifierName, String outerTitle, NoyificationTypeEnum notificationType,Long outerId){
